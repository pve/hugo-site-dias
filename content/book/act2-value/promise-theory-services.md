...
(staat al in http://localhost:1313/book/act1-foundations/promise-theory/)
•
Contracts and Service Level Agreements (SLAs): Peter connects the idea of a contract to a set of complimentary promises, http://localhost:1313/book/act1-foundations/promise-contract/ where if one party does something, the other will do something else. He clarifies that an SLA is a type of contract. He also notes that an SLA might be an "upstream SLA". Contracts in http://localhost:1313/book/act1-foundations/promise-theory/, 
